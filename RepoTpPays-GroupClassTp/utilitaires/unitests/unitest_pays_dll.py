import unittest
from ..pays_dll import *  # Import du module


class TestPaysDll(unittest.TestCase):
	...
	fichier = charger_fichier()
	
	def test_charger_le_fichier(self):
		liste_pays = self.charger_fichier()  # Charger le fichier (str)
	...
	def test_pays_code(self):
		liste_pays = self.charger_fichier()
